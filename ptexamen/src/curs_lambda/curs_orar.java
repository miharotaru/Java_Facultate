...
class Profesor {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("curs_lambda.Profesor{");
...
class Programare {
    ...
    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("curs_lambda.Programare{");
...
class Orar {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("%30s %2s %2s%n", "curs_lambda.Profesor", "C", "S");
        programari.stream()
        ...
        class Departament {
            ...
            @Override
            public String toString() {
                return String.format("%s - %d activități", denumire, numarActivitati);
            }
        }
